...
- [noble-varghese/homebrew-scribe](https://github.com/noble-varghese/homebrew-scribe) -  (2 days ago)
...
- [noble-varghese/scribe](https://github.com/noble-varghese/scribe) ([v0.1.26](https://github.com/noble-varghese/scribe/releases/tag/v0.1.26), 1 day ago) - A lightweight cross platform text-expander written in golang.
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.56.2](https://github.com/langfuse/langfuse-python/releases/tag/v2.56.2), 6 days ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
