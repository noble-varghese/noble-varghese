...
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.16](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.16), 2 days ago) - LlamaIndex in TypeScript
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.64](https://github.com/run-llama/llama_index/releases/tag/v0.10.64), 3 days ago) - LlamaIndex is a data framework for your LLM applications
