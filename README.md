...
- [Portkey-AI/portkey-python-sdk](https://github.com/Portkey-AI/portkey-python-sdk) ([v1.7.2](https://github.com/Portkey-AI/portkey-python-sdk/releases/tag/v1.7.2), today) - Build reliable, secure, and production-ready AI apps easily.
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.5.7](https://github.com/Portkey-AI/gateway/releases/tag/v1.5.7), today) - A Blazing Fast AI Gateway. Route to 200&#43; LLMs with 1 fast &amp; friendly API.
