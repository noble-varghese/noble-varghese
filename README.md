...
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.6](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.6), 1 day ago) - LlamaIndex in TypeScript
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.16.2](https://github.com/langfuse/langfuse-js/releases/tag/v3.16.2), 1 day ago) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.39.2](https://github.com/langfuse/langfuse-python/releases/tag/v2.39.2), 1 day ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.55](https://github.com/run-llama/llama_index/releases/tag/v0.10.55), 1 week ago) - LlamaIndex is a data framework for your LLM applications
