...
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.0.210](https://github.com/langchain-ai/langchainjs/releases/tag/0.0.210), today) - 
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.17.dev1](https://github.com/run-llama/llama_index/releases/tag/v0.9.17.dev1), today) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
...
- [fix: adding the package files](https://github.com/Portkey-AI/portkey-node-sdk/pull/18) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (1 week ago)
- [feat: removing the langchain and llama integrations](https://github.com/Portkey-AI/portkey-node-sdk/pull/17) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (1 week ago)
