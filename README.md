...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.12](https://github.com/run-llama/llama_index/releases/tag/v0.9.12), today) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.0.201](https://github.com/langchain-ai/langchainjs/releases/tag/0.0.201), today) - 
