...
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.0.198](https://github.com/langchain-ai/langchainjs/releases/tag/0.0.198), 1 day ago) - 
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.8.post1](https://github.com/run-llama/llama_index/releases/tag/v0.9.8.post1), 2 days ago) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
...
- [fix: adding the anthropic version header](https://github.com/Portkey-AI/Rubeus/pull/37) on [Portkey-AI/Rubeus](https://github.com/Portkey-AI/Rubeus) (4 weeks ago)
- [feat: Add support for the saved prompt generations](https://github.com/Portkey-AI/portkey-node-sdk/pull/10) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (4 weeks ago)
- [Noble varghese/type corrections](https://github.com/Portkey-AI/portkey-node-sdk/pull/9) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (4 weeks ago)
