...
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.22](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.22), 1 day ago) - LlamaIndex in TypeScript
...
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.47.1](https://github.com/langfuse/langfuse-python/releases/tag/v2.47.1), 1 day ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.11.7](https://github.com/run-llama/llama_index/releases/tag/v0.11.7), 3 days ago) - LlamaIndex is a data framework for your LLM applications
...
- [falcosecurity/falcosidekick](https://github.com/falcosecurity/falcosidekick) - Connect Falco to your ecosystem (2 days ago)
