...
- [noble-varghese/homebrew-scribe](https://github.com/noble-varghese/homebrew-scribe) -  (4 weeks ago)
...
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.57.8](https://github.com/langfuse/langfuse-python/releases/tag/v2.57.8), today) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.32.0](https://github.com/langfuse/langfuse-js/releases/tag/v3.32.0), today) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [vectordotdev/vector](https://github.com/vectordotdev/vector) ([v0.44.0](https://github.com/vectordotdev/vector/releases/tag/v0.44.0), 1 day ago) - A high-performance observability data pipeline.
