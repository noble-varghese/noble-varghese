...
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.0.8](https://github.com/Portkey-AI/gateway/releases/tag/v1.0.8), today) - A Blazing Fast AI Gateway. Route to 100&#43; LLMs with 1 fast &amp; friendly API.
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.15](https://github.com/run-llama/llama_index/releases/tag/v0.10.15), 1 day ago) - LlamaIndex is a data framework for your LLM applications
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.1.25](https://github.com/langchain-ai/langchainjs/releases/tag/0.1.25), 1 day ago) - 🦜🔗 Build context-aware reasoning applications 🦜🔗
