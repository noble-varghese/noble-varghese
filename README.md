...
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.16.2](https://github.com/langfuse/langfuse-js/releases/tag/v3.16.2), today) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.39.2](https://github.com/langfuse/langfuse-python/releases/tag/v2.39.2), today) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.5](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.5), 1 day ago) - LlamaIndex in TypeScript
...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.55](https://github.com/run-llama/llama_index/releases/tag/v0.10.55), 6 days ago) - LlamaIndex is a data framework for your LLM applications
