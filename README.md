...
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.27.3](https://github.com/langfuse/langfuse-python/releases/tag/v2.27.3), today) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
...
- [Fix: langchain async and sync batch calls](https://github.com/langfuse/langfuse-python/pull/518) on [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) (4 weeks ago)
