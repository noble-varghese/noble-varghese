...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.23](https://github.com/run-llama/llama_index/releases/tag/v0.10.23), 1 day ago) - LlamaIndex is a data framework for your LLM applications
- [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) ([v1.2.1](https://github.com/Portkey-AI/portkey-node-sdk/releases/tag/v1.2.1), 1 day ago) - Build reliable, secure, and production-ready AI apps easily.
- [Portkey-AI/portkey-python-sdk](https://github.com/Portkey-AI/portkey-python-sdk) ([v1.2.2](https://github.com/Portkey-AI/portkey-python-sdk/releases/tag/v1.2.2), 1 day ago) - Build reliable, secure, and production-ready AI apps easily.
...
- [go-gorm/gorm](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly (5 days ago)
