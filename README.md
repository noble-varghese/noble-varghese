...
- [vectordotdev/vector](https://github.com/vectordotdev/vector) ([v0.46.0](https://github.com/vectordotdev/vector/releases/tag/v0.46.0), today) - A high-performance observability data pipeline.
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.37.1](https://github.com/langfuse/langfuse-js/releases/tag/v3.37.1), 1 week ago) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.60.2](https://github.com/langfuse/langfuse-python/releases/tag/v2.60.2), 2 weeks ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
...
- [enhancement(http sink): Retrying the HTTP sink in case of 404s and request timeouts](https://github.com/vectordotdev/vector/pull/21457) on [vectordotdev/vector](https://github.com/vectordotdev/vector) (6 months ago)
...
- [espanso/espanso](https://github.com/espanso/espanso) - Cross-platform Text Expander written in Rust (1 month ago)
