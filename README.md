...
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.0.197](https://github.com/langchain-ai/langchainjs/releases/tag/0.0.197), 1 day ago) - 
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.8.post1](https://github.com/run-llama/llama_index/releases/tag/v0.9.8.post1), 1 day ago) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
