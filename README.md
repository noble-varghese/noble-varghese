...
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.7.5](https://github.com/Portkey-AI/gateway/releases/tag/v1.7.5), today) - A Blazing Fast AI Gateway with integrated Guardrails. Route to 200&#43; LLMs, 50&#43; AI Guardrails with 1 fast &amp; friendly API.
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.23.2](https://github.com/langfuse/langfuse-js/releases/tag/v3.23.2), today) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([@llamaindex/cloud@0.2.3](https://github.com/run-llama/LlamaIndexTS/releases/tag/%40llamaindex/cloud%400.2.3), today) - LlamaIndex in TypeScript
