...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.56](https://github.com/run-llama/llama_index/releases/tag/v0.10.56), 1 day ago) - LlamaIndex is a data framework for your LLM applications
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.6](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.6), 2 days ago) - LlamaIndex in TypeScript
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.16.2](https://github.com/langfuse/langfuse-js/releases/tag/v3.16.2), 2 days ago) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.39.2](https://github.com/langfuse/langfuse-python/releases/tag/v2.39.2), 2 days ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.2.10](https://github.com/langchain-ai/langchainjs/releases/tag/0.2.10), 4 days ago) - 🦜🔗 Build context-aware reasoning applications 🦜🔗
