...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.10](https://github.com/run-llama/llama_index/releases/tag/v0.9.10), 1 day ago) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.0.198](https://github.com/langchain-ai/langchainjs/releases/tag/0.0.198), 3 days ago) - 
...
- [feat: Add support for the saved prompt generations](https://github.com/Portkey-AI/portkey-node-sdk/pull/10) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (1 month ago)
- [Noble varghese/type corrections](https://github.com/Portkey-AI/portkey-node-sdk/pull/9) on [Portkey-AI/portkey-node-sdk](https://github.com/Portkey-AI/portkey-node-sdk) (1 month ago)
