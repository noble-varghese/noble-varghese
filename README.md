...
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.59.5](https://github.com/langfuse/langfuse-python/releases/tag/v2.59.5), 1 day ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.35.3](https://github.com/langfuse/langfuse-js/releases/tag/v3.35.3), 2 days ago) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
- [vectordotdev/vector](https://github.com/vectordotdev/vector) ([v0.45.0](https://github.com/vectordotdev/vector/releases/tag/v0.45.0), 3 days ago) - A high-performance observability data pipeline.
