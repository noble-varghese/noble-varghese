...
- [noble-varghese/snake_and_ladder](https://github.com/noble-varghese/snake_and_ladder) -  (1 day ago)
...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.39](https://github.com/run-llama/llama_index/releases/tag/v0.10.39), 1 day ago) - LlamaIndex is a data framework for your LLM applications
...
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([@llamaindex/experimental@0.0.31](https://github.com/run-llama/LlamaIndexTS/releases/tag/%40llamaindex/experimental%400.0.31), 3 days ago) - LlamaIndex is a data framework for your LLM applications
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.4.0](https://github.com/Portkey-AI/gateway/releases/tag/v1.4.0), 4 days ago) - A Blazing Fast AI Gateway. Route to 100&#43; LLMs with 1 fast &amp; friendly API.
- [langfuse/langfuse-js](https://github.com/langfuse/langfuse-js) ([v3.11.1](https://github.com/langfuse/langfuse-js/releases/tag/v3.11.1), 4 days ago) - 🪢 Langfuse JS/TS SDKs - Instrument your LLM app and get detailed tracing/observability. Works with any LLM or framework
...
- [pydantic/logfire](https://github.com/pydantic/logfire) - Uncomplicated Observability for Python and beyond! 🪵🔥 (2 days ago)
