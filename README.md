...
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.30.0](https://github.com/langfuse/langfuse-python/releases/tag/v2.30.0), today) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([@llamaindex/experimental@0.0.27](https://github.com/run-llama/LlamaIndexTS/releases/tag/%40llamaindex/experimental%400.0.27), 1 day ago) - LlamaIndex is a data framework for your LLM applications
...
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.3.0](https://github.com/Portkey-AI/gateway/releases/tag/v1.3.0), 5 days ago) - A Blazing Fast AI Gateway. Route to 100&#43; LLMs with 1 fast &amp; friendly API.
...
- [keploy/keploy](https://github.com/keploy/keploy) - Test generation for Developers. Generate tests and stubs for your application that actually work! (5 days ago)
