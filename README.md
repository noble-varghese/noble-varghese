...
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([@llamaindex/experimental@0.0.61](https://github.com/run-llama/LlamaIndexTS/releases/tag/%40llamaindex/experimental%400.0.61), 3 days ago) - LlamaIndex in TypeScript
...
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.2.11](https://github.com/langchain-ai/langchainjs/releases/tag/0.2.11), 6 days ago) - 🦜🔗 Build context-aware reasoning applications 🦜🔗
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.58](https://github.com/run-llama/llama_index/releases/tag/v0.10.58), 6 days ago) - LlamaIndex is a data framework for your LLM applications
