...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.8.39](https://github.com/run-llama/llama_index/releases/tag/v0.8.39), today) - LlamaIndex (GPT Index) is a data framework for your LLM applications
