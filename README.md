...
- [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway) ([v1.7.1](https://github.com/Portkey-AI/gateway/releases/tag/v1.7.1), 1 day ago) - A Blazing Fast AI Gateway with integrated Guardrails. Route to 200&#43; LLMs, 50&#43; AI Guardrails with 1 fast &amp; friendly API.
- [langfuse/langfuse-python](https://github.com/langfuse/langfuse-python) ([v2.45.0](https://github.com/langfuse/langfuse-python/releases/tag/v2.45.0), 1 day ago) - 🪢 Langfuse Python SDK - Instrument your LLM app with decorators or low-level SDK and get detailed tracing/observability. Works with any LLM or framework
