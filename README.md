...
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.15](https://github.com/run-llama/llama_index/releases/tag/v0.10.15), today) - LlamaIndex is a data framework for your LLM applications
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.1.25](https://github.com/langchain-ai/langchainjs/releases/tag/0.1.25), today) - 🦜🔗 Build context-aware reasoning applications 🦜🔗
