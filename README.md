...
- [Portkey-AI/portkey-python-sdk](https://github.com/Portkey-AI/portkey-python-sdk) ([v1.1.0](https://github.com/Portkey-AI/portkey-python-sdk/releases/tag/v1.1.0), today) - Build reliable, secure, and production-ready AI apps easily.
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.9.24](https://github.com/run-llama/llama_index/releases/tag/v0.9.24), 3 days ago) - LlamaIndex (formerly GPT Index) is a data framework for your LLM applications
