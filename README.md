...
- [langchain-ai/langchainjs](https://github.com/langchain-ai/langchainjs) ([0.2.11](https://github.com/langchain-ai/langchainjs/releases/tag/0.2.11), today) - 🦜🔗 Build context-aware reasoning applications 🦜🔗
- [run-llama/llama_index](https://github.com/run-llama/llama_index) ([v0.10.58](https://github.com/run-llama/llama_index/releases/tag/v0.10.58), today) - LlamaIndex is a data framework for your LLM applications
- [run-llama/LlamaIndexTS](https://github.com/run-llama/LlamaIndexTS) ([llamaindex@0.5.9](https://github.com/run-llama/LlamaIndexTS/releases/tag/llamaindex%400.5.9), today) - LlamaIndex in TypeScript
